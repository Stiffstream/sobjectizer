 ...
 * An instance of message_holder_t is used.
 */
...
public :
	agent_with_limit_t(
		...
		:	so_5::agent_t{ ctx
				+ limit_then_transform( 1u,
						[this]( const msg_initial_message & msg ) {
							auto fresh_msg = so_5::message_holder_t<
										so_5::mutable_msg< msg_transformed_message > >::make(
									"<" + msg.m_msg + ">" );
		...
		,	m_transformed_mbox{ so_make_new_direct_mbox() }
	{}
	...
	so_define_agent() override
	{
		so_subscribe_self()
			...
			;
		so_subscribe( m_transformed_mbox )
...
private :
	const so_5::mbox_t m_transformed_mbox;
