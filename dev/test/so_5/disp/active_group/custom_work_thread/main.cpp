...
run_test()
{
	...
	so_5::launch( [&]( so_5::environment_t & env ) {
			env.introduce_coop( [&]( so_5::coop_t & coop ) {
					auto disp_params = so_5::disp::active_group::disp_params_t{};
					...
					coop.make_agent_with_binder< a_test_t >( disp.binder("1") );
					coop.make_agent_with_binder< a_test_t >( disp.binder("2") );
					coop.make_agent_with_binder< a_test_t >( disp.binder("1") );
				} );
		},
	...
	ensure_or_die( 2 == factory->started(),
			"unexpected number of started threads" );
	ensure_or_die( 2 == factory->finished(),
			"unexpected number of finished threads" );
	ensure_or_die( 2 == factory->created(),
			"unexpected number of created threads" );
	ensure_or_die( 2 == factory->destroyed(),
