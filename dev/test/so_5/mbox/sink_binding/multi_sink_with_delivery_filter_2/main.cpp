/*
 * A simple case for multi_sink_binding_t and delivery_filter.
 * The delivery_filter will be specified by a lambda that receives
 * a `const auto &` reference.
 */
...
introduce_test_coop( so_5::environment_t & env )
	{
		env.introduce_coop( []( so_5::coop_t & coop ) {
				...
				auto consumer_sink = so_5::wrap_to_msink( consumer->so_direct_mbox() );
