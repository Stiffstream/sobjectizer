...
struct implicit_type_free_func_no_optional_no_dr_t : public implicit_type_case_t
	{
		template< typename Source_Msg, typename Result_Msg >
		struct actual_transformer_t
			{
				[[nodiscard]]
				static so_5::transformed_message_t< Result_Msg >
		...
		name() { return { "implicit_type_free_func_no_optional_no_dr" }; }
...
run_implicit_type_free_func_no_optional_no_dr()
	{
		run_tests_for_case_handler< implicit_type_free_func_no_optional_no_dr_t >();
	}
