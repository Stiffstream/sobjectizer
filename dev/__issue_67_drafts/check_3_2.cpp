		...
		so_evt_start() override
			{
				...
				so_5::send< so_5::mutable_msg<msg_full> >( m_dest_2, 2, 0 );
				so_5::send< so_5::mutable_msg<msg_full> >( m_dest_1, 2, 0 );
			}
	};
				...
				so_5::bind_then_transform< so_5::mutable_msg<msg_full> >(
						*binding,
						...
						[d = part_two->so_direct_mbox()]( auto & msg )
							-> std::optional< so_5::transformed_message_t< msg_part_two > >
						{
							if( 1 == msg.m_two.m_y )
								return {
										so_5::make_transformed< msg_part_two >( d, msg.m_two )
									};
							else
								{
